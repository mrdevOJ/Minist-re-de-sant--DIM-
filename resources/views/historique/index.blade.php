  ...
  <div class="container-fluid ">
    ...
    <div class="collapse navbar-collapse " id="navbarSupportedContent">
      ...
      <div class="container">
        ...
        <input class="form-control me-1"  name='date' type="date" >
...
@endif  <th scope="col">Supprimer</th>
 ...
 @foreach($reservations as $reservation)
    ...
    <tr>       
      ...
      <td >        @if( Auth::user()->username =="adminadmin")

  <a type="button" class=" btn btn-warning dark" href="{{route('reservation.edit',$reservation->id)}}">Edite</a> 
  @endif </td> <td> 
  <form action="{{route('historique.destroy',$reservation->id)}}" method="post"> 

    @csrf
    <button type="submit"  class="btn btn-danger" > Supprimer</button>    @method('DELETE')</form> </td>
    </tr>
         @endforeach
